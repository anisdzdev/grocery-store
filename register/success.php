...
<div class="d-flex justify-content-center align-items-center recovery-container">
    <form class="sign-form text-center" id="recovery-form" action="signin.html">
        <h1 class="mb-5">Thank You!</h1>
        <p>Thank you for registering with us. Click <a class="link" href="signin.html"> here </a> to login!</p>
    </form>
</div>
