    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/popcorn.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Popcorn</h4>
                <p>
                    Movie night ? Inviting her ? **wink wink**
                </p>
                <p class="product-price">
                    $<span id="productPrice">2.99</span> each
                </p>
