    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/doritos.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Chips</h4>
                <p>
                    Delicious honey crispy chip bags, just for your party nights.
                </p>
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                ...
                <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <a class="productLink" href="../fruitsAndVeg/apple.php">
                        <div class="product card-aisle rounded uk-card-default card product">
                            ...
                            <div class="card-body productDetails">
                                ...
                                <p class="productPrice">$16.37/Kg</p>
                            </div>
                        </div>
                    </a>
                </div>
