    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/granola-bar.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Granola Bar</h4>
                <p>
                    Healthy granola bar to boost your day.
                </p>
                <p class="product-price">
                    $<span id="productPrice">2.47</span> each
                </p>
