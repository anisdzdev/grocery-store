    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/pretzel.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Pretzel</h4>
                <p>
                    Crunchy pretzels for everyone!
                </p>
                <p class="product-price">
                    $<span id="productPrice">3.99</span> each
                </p>
