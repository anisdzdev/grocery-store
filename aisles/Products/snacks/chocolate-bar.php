    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../assets/images/articles/Chocolate_Bar.jpg" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Chocolate Bar</h4>
                <p>
                    Delicious honey crisp apples, freshly picked just for you.
                </p>
                <p class="product-price">
                    $<span id="productPrice">2.99</span>
                </p>
            ...
            <div class="row">
                ...
                <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="product card-aisle rounded uk-card-default card product">
                        <a class="productLink" href="almond.php">
