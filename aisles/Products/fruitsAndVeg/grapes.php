    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/grapes.jpg" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Grapes</h4>
                <p>
                    Green seedless grapes, to make you feel like a Greek warrior.
                </p>
                <p class="product-price">
                    $<span id="productPrice">0.70</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="0.70" name="unitary">
