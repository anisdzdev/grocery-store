    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/oranges.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Oranges</h4>
                <p>
                    Our famous oranges are all grown in the great state of Florida! Florida oranges are famous for the sweetness and juiciness, and now you get to enjoy them!
                </p>
                <p class="product-price">
                    $<span id="productPrice">1.50</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="1.50" name="unitary">
