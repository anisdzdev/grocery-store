    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/spinach.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Spinach</h4>
                <p>
                    Fresh spinach full of nutrients to make you strong and BIG!
                </p>
                <p class="product-price">
                    $<span id="productPrice">0.99</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="0.99" name="unitary">
