    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/tomato.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Tomato</h4>
                <p>
                    Our tomatoes can cater for any of your needs, whether it be for pizza sauce or a simple salad!
                </p>
                <p class="product-price">
                    $<span id="productPrice">0.20</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="0.20" name="unitary">
...
<div class="container mt-5 mb-5">
            <div class="row">
                ...
                <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="product card-aisle rounded  uk-card-default card product">
                        <a class="productLink" href="oranges.php">
