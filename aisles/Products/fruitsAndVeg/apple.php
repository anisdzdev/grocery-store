    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/Apple_Product_Page.jpg" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Apples</h4>
                <p>
                    Delicious honey crisp apples, freshly picked just for you.
                </p>
                <p class="product-price deal">
                    $<span id="productPrice">0.79</span> each
                </p>
