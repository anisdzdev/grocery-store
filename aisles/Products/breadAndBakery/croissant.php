    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/croissant.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Croissant</h4>
                <p>
                    A grand perfect puffy croissant.
                </p>
                <p class="product-price">
                    $<span id="productPrice">4.45</span>/5pcs
                </p>
