    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/hamburger-bun.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Hamburger Bun</h4>
                <p>
                    With this delicious Hamburger Bun you will eat all your hamburgers.
                </p>
                <p class="product-price">
                    $<span id="productPrice">4.99</span>/Lb
                </p>
