    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/hotdog-bun.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Hot Dog Bun</h4>
                <p>
                    This hot dog bun is perfectly made for your summer vacation.
                </p>
