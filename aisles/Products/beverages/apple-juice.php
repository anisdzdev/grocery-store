    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/apple-juice.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Apple Juice</h4>
                <p>
                    Amazing apple juice to boost your mornings, made with fresh apples!
                </p>
                <p class="product-price deal">
                    $<span id="productPrice">1.56</span> each
                </p>
