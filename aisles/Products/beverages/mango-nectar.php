    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/mango-nectar.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Mango Nectar</h4>
                <p>
                    The most wanted juice ever created. It's available in our store.
                </p>
                <p class="product-price">
                    $<span id="productPrice">9.44</span> each
                </p>
