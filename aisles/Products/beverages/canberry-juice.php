    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/cranberry-juice.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title"></h4>
                <p>
                    Try out the new Cranberry juice only available for a limited time
                </p>
                <p class="product-price">
                    $<span id="productPrice">5.28</span> each
                </p>
