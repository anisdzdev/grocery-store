    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/orange-juice.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Orange Juice</h4>
                <p>
                    Mouthwatering orange juice to give you Vitamin C, made with freshly harvested oranges!
                </p>
                <p class="product-price">
                    $<span id="productPrice">3.58</span> each
                </p>
