    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img style="height: 500px;" src="../../../assets/images/articles/Pineapple%20Juice.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Pineapple Juice</h4>
                <p>
                    Pineapple juice for those who want to taste power.
                </p>
                <p class="product-price">
                    $<span id="productPrice">12.29</span> each
                </p>
