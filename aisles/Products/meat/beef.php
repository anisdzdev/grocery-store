    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/beef.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Beef</h4>
                <p>
                    Fresh Canadian Grain Fed AAA Filet Mignon steaks aged a minimum of 28 days to perfection
                </p>
                <p class="product-price">
                    $<span id="productPrice">25.99/Kg</span>
                </p>
    ...
    <div class="Recommended">
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                ...
                <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="product card-aisle rounded  uk-card-default card product">
                        <a class="productLink" href="chickenBreast.php">
                ...
                <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="product card-aisle rounded  uk-card-default card product">
                        <a class="productLink" href="chicken-wings.php">
