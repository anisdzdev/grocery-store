    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/turkey.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Turkey</h4>
                <p>
                    Sharply cut turkey slices from the region
                </p>
                <p class="product-price">
                    $<span id="productPrice">19.99/Kg</span>
                </p>
