    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/brown-eggs.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Eggs</h4>
                <p>
                    A dozen brown eggs, sourced in humane ways.
                </p>
                <p class="product-price">
                    $<span id="productPrice">5.99</span>/dz
                </p>
