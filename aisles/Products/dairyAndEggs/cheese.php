    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/cheese.png" alt="cheesy">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Cheese</h4>
                <p>
                    Delicious and flavorful aged mozzarella. It will give you a taste of Italy!
                </p>
                <p class="product-price deal">
                    $<span class="deal" id="productPrice">7.99</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="8.99" name="unitary">
