    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/white-eggs.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">White Eggs</h4>
                <p>
                    A dozen white eggs, sourced in the most humane ways.
                </p>
