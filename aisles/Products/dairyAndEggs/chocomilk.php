    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/chocolate-milk.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title">Chocolate Milk</h4>
                <p>
                    Our amazing milk, but this time with chocolate!
                </p>
                <p class="product-price">
                    $<span id="productPrice">7.99</span> each
                </p>
                ...
                <label>
                    ...
                    <input type="hidden" value="7.99" name="unitary">
