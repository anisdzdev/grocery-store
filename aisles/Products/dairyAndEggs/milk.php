    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 marg">
                <br>
                <img src="../../../assets/images/articles/milk-bag.png" alt="">
            </div>

            <div class="col-md-7 marg">
                <br>
                <h4 class="pro-d-title product-title" id="title">Milk</h4>
                <p>
                    The best milk for your coffee, tea, cereal, or all your other culinary needs!
                </p>
                <p class="product-price">
                    $<span id="productPrice">5.99</span> each
                </p>
