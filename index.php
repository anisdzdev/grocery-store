...
<nav class="navbar sticky-top navbar-custom navbar-expand-lg navbar-light">
  ...
  <div class="jumbotron jumbotron-homepage jumbotron-fluid">
    <div class="container">
      <h1 class="display-4 text" style="margin-left: 100px; margin-right:100px; color: white">Welcome to Tropical Flavors!</h1>
  ...
  <div class="faq">
    ...
    <h5 class="text">Due to limited supply and high demand, orders have been delayed. However, we are trying our best to get your order to you on time!</h5>

    <h3 class="text">Do I need an account to place an order?</h3>
    <h5 class="text link">Yes, an account is required to order from Tropical Flavours. If you haven't created one, click <a  class="link" target="_blank" href="register/signup.html"> here </a> to sign up.</h5>
